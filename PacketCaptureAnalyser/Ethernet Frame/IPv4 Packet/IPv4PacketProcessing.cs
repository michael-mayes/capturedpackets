...
namespace EthernetFrameNamespace.IPv4PacketNamespace
{
    class IPv4PacketProcessing
    {
        public bool ProcessIPv4Packet(System.IO.BinaryReader ThePackageCaptureBinaryReader)
        {
            ...
            TheIPv4Header.VersionAndHeaderLength = ThePackageCaptureBinaryReader.ReadByte();
            TheIPv4Header.TypeOfService = ThePackageCaptureBinaryReader.ReadByte();
            TheIPv4Header.TotalLength = (System.UInt16)System.Net.IPAddress.NetworkToHostOrder(ThePackageCaptureBinaryReader.ReadInt16());
            TheIPv4Header.Identifier = (System.UInt16)System.Net.IPAddress.NetworkToHostOrder(ThePackageCaptureBinaryReader.ReadInt16());
            TheIPv4Header.FlagsAndOffset = ThePackageCaptureBinaryReader.ReadUInt16();
            TheIPv4Header.TimeToLive = ThePackageCaptureBinaryReader.ReadByte();
            TheIPv4Header.Protocol = ThePackageCaptureBinaryReader.ReadByte();
            TheIPv4Header.HeaderChecksum = ThePackageCaptureBinaryReader.ReadUInt16();
            TheIPv4Header.SourceAddress = ThePackageCaptureBinaryReader.ReadInt32();
            TheIPv4Header.DestinationAddress = ThePackageCaptureBinaryReader.ReadInt32();
                    ...
                    case IPv4PacketConstants.IPv4PacketHeaderProtocolICMP:
                        {
                            ...
                            TheResult = TheICMPv4PacketProcessing.ProcessICMPv4Packet(ThePackageCaptureBinaryReader, TheIPv4PayloadLength);
                            break;
                        }
                    ...
                    case IPv4PacketConstants.IPv4PacketHeaderProtocolIGMP:
                        {
                            ...
                            TheResult = TheIGMPv2PacketProcessing.ProcessIGMPv2Packet(ThePackageCaptureBinaryReader, TheIPv4PayloadLength);
                            break;
                        }
                    ...
                    case IPv4PacketConstants.IPv4PacketHeaderProtocolTCP:
                        {
                            ...
                            TheResult = TheTCPPacketProcessing.ProcessTCPPacket(ThePackageCaptureBinaryReader, TheIPv4PayloadLength);
                            break;
                        }
                    ...
                    case IPv4PacketConstants.IPv4PacketHeaderProtocolUDP:
                        {
                            ...
                            TheResult = TheUDPDatagramProcessing.ProcessUDPDatagram(ThePackageCaptureBinaryReader, TheIPv4PayloadLength);
                            break;
                        }
