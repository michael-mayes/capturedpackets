...
namespace EthernetFrame.ARPPacket
{
    class Structures
    {
        ...
        public struct PacketStructure
        {
            ...
            public ushort ProtocolType; // The internetwork protocol for which the ARP request is intended (e.g. IPv4 is 0x0800) - same possible values as for Ether Type in Ethernet frame header
            ...
            public byte ProtocolAddressLength; // Length (in octets) of addresses used in the upper layer internetwork protocol (e.g. IPv4 address size is 4)
