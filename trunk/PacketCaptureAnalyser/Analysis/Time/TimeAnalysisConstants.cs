...
namespace AnalysisNamespace
{
    class TimeAnalysisConstants
    {
        ...
        public const int TimeAnalysisTimestampBinsPerMs = 10; //Ten value bins for every millisecond of latency
        ...
        public const int TimeAnalysisTimeBinsPerMs = 200; //Ten value bins for every millisecond of latency
